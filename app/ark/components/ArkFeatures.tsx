...
export default function ArkFeatures() {
  ...
  return (
    <section id="ark-pricing" className="py-20 bg-gradient-to-b from-gray-50 to-white">
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                  <div className="bg-gradient-to-r from-emerald-500 to-green-500 text-white px-4 lg:px-5 py-1 lg:py-1.5 rounded-full text-xs lg:text-sm font-semibold shadow-md">
                    最受歡迎
                  </div>
                </div>
              )}
              ...
              {/* 熱門方案的微妙邊框 */}
              {plan.popular && (
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-400/20 to-green-400/20 rounded-2xl -m-0.5 z-0"></div>
              )}

              <div className="relative z-10 p-6">
                {/* 方案名稱 */}
                <h3 className="text-xl font-bold text-gray-900 mb-1">{plan.name}</h3>
                <div className="text-2xl font-bold text-emerald-600 mb-6">{plan.price}</div>
              ...
              <div className={`absolute inset-0 rounded-2xl transition-all duration-300 ${
                hoveredPlan === plan.id 
                  ? 'bg-gradient-to-br from-emerald-50/80 to-green-50/80 shadow-lg shadow-emerald-200/50 scale-105' 
                  : ''
              }`}></div>
            </div>
          ))}
