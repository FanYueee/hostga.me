...
export default function ArkHighlights() {
              ...
              {row.map((item) => (
                <div
                  ...
                  className={`flex items-center gap-4 p-4 rounded-xl transition-all duration-300 cursor-pointer ${
                    hoveredItem === item.id 
                      ? 'bg-gradient-to-r from-emerald-50 to-green-50 shadow-md lg:scale-105' 
                      : 'hover:bg-gray-50'
                  }`}
                ...
                >
                  ...
                  <div className={`flex-shrink-0 w-12 h-12 rounded-full flex items-center justify-center text-xl transition-all duration-300 ${
                    hoveredItem === item.id 
                      ? 'bg-gradient-to-r from-emerald-500 to-green-500 shadow-lg shadow-emerald-200 lg:scale-110' 
                      : 'bg-gray-100'
                  }`}>
                  ...
                  <div className="flex-1">
                    <h3 className={`font-semibold text-gray-900 mb-1 transition-colors duration-300 ${
                      hoveredItem === item.id ? 'text-emerald-600' : ''
                    }`}>
                      {item.title}
                    </h3>
