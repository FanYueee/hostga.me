...
export default function AcceptableUsePolicyPage() {
  ...
  const openPdfInNewTab = () => {
    window.open('https://vproxy-legal.pages.dev/vProxyCloud_AUP.pdf', '_blank')
  }
        ...
        <div className={`bg-white rounded-2xl shadow-lg overflow-hidden transition-all duration-1000 delay-300 ${
          ...
          {pdfError ? (
            ...
            <div className="relative" style={{ height: '120vh' }}>
              <iframe
                src="https://vproxy-legal.pages.dev/vProxyCloud_AUP.pdf#toolbar=1&navpanes=1&scrollbar=1"
