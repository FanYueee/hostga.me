  ...
  const plans = [
    {
      ...
      network: '100 Mbps',
      players: '10-20 人',
      features: ['DDoS 防護', '自動備份', '基礎支援', '物品重置保護'],
      price: 'NT$ 599/月',
      popular: false
    },
    {
      ...
      network: '250 Mbps',
      players: '20-50 人',
      features: ['DDoS 防護', '自動備份', '優先支援', '免費子網域', '自訂載入點'],
      price: 'NT$ 999/月',
      popular: true
    },
    {
      ...
      network: '500 Mbps',
      players: '50-100 人',
      features: ['DDoS 防護', '自動備份', '24/7 專屬支援', '免費子網域', '效能優化', '戰利品定制'],
      price: 'NT$ 1999/月',
      popular: false
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            專為 DayZ 生存遊戲優化的伺服器配置，打造你的末日生存世界
          </p>
        </div>
            ...
            >
              ...
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
                  <div className="bg-gradient-to-r from-blue-500 to-slate-500 text-white px-4 lg:px-5 py-1 lg:py-1.5 rounded-full text-xs lg:text-sm font-semibold shadow-md">
                    最受歡迎
                  </div>
                </div>
              )}
              ...
              {/* 熱門方案的微妙邊框 */}
              {plan.popular && (
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400/20 to-slate-400/20 rounded-2xl -m-0.5 z-0"></div>
              )}
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-indigo-100 rounded-md flex items-center justify-center mr-2.5">
                ...
                <Link
                  ...
                  className={`block w-full mt-6 py-2.5 px-4 rounded-lg font-medium text-sm text-center transition-all duration-300 ${
                    plan.popular
                      ? 'bg-gradient-to-r from-blue-500 to-slate-500 text-white hover:shadow-lg hover:scale-105'
              ...
              <div className={`absolute inset-0 rounded-2xl transition-all duration-300 ${
                hoveredPlan === plan.id 
                  ? 'bg-gradient-to-br from-blue-50/80 to-slate-50/80 shadow-lg shadow-blue-200/50 scale-105' 
                  : ''
              }`}></div>
            </div>
          ))}
